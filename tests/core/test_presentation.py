...
def test_repo_card_shows_compact_stats_value_guidance_and_actions() -> None:
    ...
    assert "<b>Study:</b>" not in html
    assert "<b>Evidence:</b>" not in html
    ...
    assert "Study pyproject.toml and examples/run.py." not in html
    assert "Trace examples/run.py." not in html
